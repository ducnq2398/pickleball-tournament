  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/70 p-0 sm:items-center sm:p-4">
      ...
      <div
        ...
        aria-label={title}
        className={cn(
          "relative z-10 max-h-[92vh] w-full overflow-y-auto rounded-t-2xl border border-ink-700 bg-ink-850 shadow-2xl sm:rounded-2xl",
          widths[size],
        )}
      >
        ...
        {footer ? (
          <div className="flex flex-wrap justify-end gap-2 border-t border-ink-700/60 px-5 py-4">
            {footer}
          </div>
        ) : null}
      </div>
