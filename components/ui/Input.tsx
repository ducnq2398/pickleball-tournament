...
const BASE =
  "w-full rounded-lg border border-ink-600 bg-ink-900 px-3 py-2 text-sm text-ink-100 placeholder:text-ink-500 " +
...
export function Toggle({
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-between gap-4 rounded-lg border border-ink-600 bg-ink-900 px-3 py-2.5 text-left disabled:opacity-50"
    >
      <span>
